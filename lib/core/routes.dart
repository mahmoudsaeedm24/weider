...
import 'package:weider/features/me/me_screen.dart';
...
class Screens {
  ...
  static const String meInfo = 'meInfo';
}
...
Route<dynamic>? onGenerateRoute(RouteSettings settings) {
  switch (settings.name) {
    ...
    case Screens.meInfo: // أو Screens.addNewUser.name
      return MaterialPageRoute(builder: (context) => const MeScreen());
